...
class GlowCookies {
  ...
  createDOMElements() {
    ...
    this.Cookies.innerHTML = `<div 
                                ...
                                >
                                    <h3 style="color: #00395f;">${this.banner.heading}</h3>
                                    <p style="color: #00395f;">
  ...
  init() {
    this.arrLang = {
      ...
      pt_BR: {
        ...
        'bannerDescription': 'Este site utiliza cookies para te proporcionar uma melhor experiência. Ao continuar navegando, você aceita nossa',
